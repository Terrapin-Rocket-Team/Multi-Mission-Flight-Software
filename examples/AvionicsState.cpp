...
AvionicsState::AvionicsState(Sensor **sensors, int numSensors, LinearKalmanFilter *kfilter, Logger *logger, bool stateRecordsOwnData) : State(sensors, numSensors, kfilter, logger, stateRecordsOwnData)
{
    stage = 0;
    timeOfLaunch = 0;
    timeOfLastStage = 0;
